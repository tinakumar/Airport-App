...
class AirportsControllerTest < ActionController::TestCase
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post :create, airport: { city: @airport.city, code: @airport.code, created_at: @airport.created_at, updated_at: @airport.updated_at }
    end
  ...
  test "should update airport" do
    put :update, id: @airport, airport: { city: @airport.city, code: @airport.code, created_at: @airport.created_at, updated_at: @airport.updated_at }
    assert_redirected_to airport_path(assigns(:airport))
  end
